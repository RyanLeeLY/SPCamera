...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder]) {
        ...
        _contextQueue = dispatch_queue_create("com.SPOpenGLView.contextQueue", DISPATCH_QUEUE_SERIAL);
