...
// Defaults
#define TPF_CIRCLE_COLOR_DEFAULT [UIColor colorWithRed:239/255.0f green:101/255.0f blue:48/255.0f alpha:1]
#define TPF_CIRCLE_BACKGROUND_COLOR_DEFAULT [UIColor colorWithWhite:.85f alpha:1]
#define TPF_CIRCLE_FILL_COLOR_DEFAULT [UIColor clearColor]
#define TPF_CIRCLE_TIMER_WIDTH 8.0f

@protocol SPCircleCounterDelegate;

@interface SPCircleCounter : UIView

/// The receiver of all counter delegate callbacks.
@property (nonatomic, weak) id<SPCircleCounterDelegate> delegate;

/// The color of the circle indicating the remaining amount of time - default is TPF_CIRCLE_COLOR_DEFAULT.
@property (nonatomic, strong) UIColor *circleColor;

/// The color of the circle indicating the expired amount of time - default is TPF_CIRCLE_BACKGROUND_COLOR_DEFAULT.
@property (nonatomic, strong) UIColor *circleBackgroundColor;

/// The color of inside of the circle - default is TPF_CIRCLE_FILL_COLOR_DEFAULT.
@property (nonatomic, strong) UIColor *circleFillColor;

/// The thickness of the circle color - default is TPF_CIRCLE_TIMER_WIDTH.
...
@protocol SPCircleCounterDelegate <NSObject>
